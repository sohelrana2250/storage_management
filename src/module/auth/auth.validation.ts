 ...
 const resetVerification = z.object({
     body: z.object({
       verificationCode: z
         ...
         .min(6, { message: 'min 6 character accepted' }).optional(),
         newpassword:z.string({required_error:"new password is required"}).min(6,{message:"min 6 charcter accepted"}).optional()
     }),
   });
